...
const tldr_data = [
  <>
    • <strong>2 years</strong> of experience across <strong>startups</strong>,{" "}
    <strong>Fortune 500</strong>, and <strong>FAANG</strong>
  </>,
  <>
    • <strong>3.94 GPA</strong>,{" "}
    {" Bachelor's of Computing, Major in CS, graduating May 2026"}
  </>,
  <>
    {"• Founded my university's GDSC, raised "} <strong>25K+</strong> for
    student initiatives
  </>,
...
const TLDR = () => {
  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", mt: 2, mb: 1 }}>
      <Typography variant="CVText">Highlights</Typography>
      ...
      <Box sx={{ display: "flex", mt: 2 }}>
        ...
        <Box sx={{ ml: 2 }}>
          <Link
            href="mailto:vincemoschella04@gmail.com"
            sx={{ "&:hover": { opacity: 0.7 } }}
          >
