        ...
        >
          ...
          >
            <Typography component="h3" variant="h3" sx={{ mb: 2, mr: -500 }}>
              <span
                style={{ WebkitTextStrokeColor: theme.palette.orange.bright }}
              >
                About{" "}
              </span>
            ...
            <Typography component="p" variant="p">
              Hi, I&apos;m Vince and I&apos;m glad you found my site! I&apos;m a
              recent graduate based in Toronto. I love to take on challenges and
              make things that solve real world problems. When I&apos;m not
              breaking prod, I&apos;m{" "}
              <HoverTextAppear newText={"(how it will inevitably replace me)"}>
                learning about AI
              </HoverTextAppear>
              , practicing some calisthenics at the gym, crafting a new spotify
              playlist, or{" "}
