  ...
  const jobInfo = [
    {
      ...
      technologies: "Java, React, Typescript, Lambda, DynamoDB, CloudFormation",
      descriptionText:
        "I worked on the Oracle DB on AWS team, where I designed and implemented a Java middleware layer that intercepts incoming requests and delivers customer availability zone mappings to OCI. I also built a custom caching layer which preloaded data from DynamoDB on Lambda initialization so certain lookup opearations stay quick and stable. I also updated storage models and workflow APIs to support private-network integrations for Oracle Database networks shared through AWS Resource Access Manager.",
    ...
    },
    {
      ...
      technologies:
        "Leadership, Team Management, Event Planning, Web/Mobile Development",
      descriptionText:
